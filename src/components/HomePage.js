...
const HomePage = () => {
  ...
  const recommendedMobile = allProducts.find((product) => product.category === "Mobiles");
  const recommendedWatch = allProducts.find((product) => product.category === "Watches");
  ...
  return (
    ...
    >
      ...
      {/* Main content container: All Products on left, Recommended on right */}
      <div className="main-content">
        <div className="all-products-section">
          <h2><label style={{ color: "black" }}>All Products</label></h2>
